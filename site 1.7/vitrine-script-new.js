...
const produtos = {
    ...
    obi: {
        ...
        linkFisico: "https://pay.hotmart.com/U102160366G"
    },
    ewe: {
        ...
        linkFisico: "https://pay.hotmart.com/G102177949Q"
    },
    ilu: {
        ...
        precoFisico: "R$ 69,99",
        precoFisicoOriginal: "R$ 94,99",
        imagem: "img/ilu odara folha.png",
        badges: [],
    ...
    ounje: {
        ...
        linkFisico: "https://pay.hotmart.com/K102174463K"
    },
    "oruko-nomes": {
        ...
        linkFisico: "https://pay.hotmart.com/B102174490T"
    },
    "coletanea-orisa": {
    ...
    "combo-oraculo": {
        ...
        preco: "R$ 59,99",
        precoEbook: "R$ 59,99",
        precoEbookOriginal: "R$ 94,98",
        precoFisico: "R$ 159,99",
        precoFisicoOriginal: "R$ 194,98",
        imagem: "img/combo_oraculo.png",
        badges: ["2ª Edição"],
        descricao: "Focado nos sistemas oraculares tradicionais, este combo é perfeito para quem quer aprender sobre Obì e Èrìndílógún. Conhecimento profundo sobre as artes divinatórias yorùbá com edições atualizadas.",
        destaques: [
            "Aprendendo a Jogar Obì - 2ª Edição",
            "Odù no Èèrìndílógún - 2ª Edição",
            "Foco em sistemas oraculares",
            "Versões mais completas e atualizadas",
            "Ideal para consulentes e estudiosos"
        ],
        dados: {
            "Livros Inclusos": "2 livros (2ª Edição)",
            "Edição": "2ª Ed",
            "Formato": "E-book / Livro Físico",
            "Valor Individual": "Consultar produtos separados",
            "Acesso": "Imediato / 5-10 dias úteis"
        },
        linkCompra: "https://pay.hotmart.com/W101256953G",
        linkEbook: "https://pay.hotmart.com/W101256953G",
        linkFisico: "https://pay.hotmart.com/D102174811H"
    },
    "combo-oferendas": {
    ...
    "combo-personalizado": {
        ...
        precoEbook: "A partir de R$ 49,99",
        precoEbookOriginal: "Economia até 20%",
        precoFisico: "A partir de R$ 119,99",
        precoFisicoOriginal: "Desconto Progressivo",
        imagem: "img/solicitar.jpg",
        badges: ["Personalizado"],
        descricao: "Monte seu combo ideal escolhendo os livros que mais interessam a você. Quanto mais livros selecionar, maior o desconto! Sistema de desconto progressivo: 5% (1-2 livros), 10% (3-5 livros), 15% (6-9 livros), 20% (10+ livros). Consulte através do WhatsApp para valores personalizados.",
        destaques: [
            "Escolha os livros que você quer",
        ...
        dados: {
            "Formato": "Digital (PDF) / Físico",
            "Desconto Mínimo": "5% (1-2 livros)",
            "Desconto Máximo": "20% (10+ livros)",
            "Atendimento": "WhatsApp personalizado",
            "Preço Base E-book": "Média R$ 35,00 por livro",
            "Preço Base Físico": "Média R$ 85,00 por livro"
        },
        linkCompra: "https://wa.me/5592991549151?text=Olá! Gostaria de montar um combo personalizado de livros. Podem me enviar informações sobre preços e descontos?",
        linkEbook: "https://wa.me/5592991549151?text=Olá! Gostaria de montar um combo personalizado de livros digitais (E-books). Podem me ajudar com os preços e descontos disponíveis?",
        linkFisico: "https://wa.me/5592991549151?text=Olá! Gostaria de montar um combo personalizado de livros físicos. Podem me informar sobre preços, descontos e frete?"
    },
    "dicionario-por-you": {
        titulo: "Dicionário - Português - Yorùbá",
        preco: "R$ 99,99",
        precoEbook: "R$ 99,99",
        precoEbookOriginal: "R$ 129,99",
        precoFisico: "R$ 189,99",
        precoFisicoOriginal: "R$ 219,99",
        imagem: "img/dicionario_por_you.png?v=20251007",
        badges: [],
        descricao: "Neste guia fundamental, Bàbá Akindele apresenta uma das obras mais completas já publicadas sobre a língua sagrada dos Òrìṣà. O Dicionário Português–Yorùbá reúne centenas de palavras cuidadosamente selecionadas, traduzidas e organizadas com a grafia correta, os tons e significados preservados segundo a tradição yorùbá.\n\nMais do que um simples dicionário, esta obra é um elo entre o sagrado e o cotidiano, um instrumento que auxilia estudantes, pesquisadores, iniciados e amantes da cultura yorùbá a compreender e pronunciar corretamente as palavras que ecoam nos cânticos, orações e rituais.\n\nCada termo foi tratado com respeito à ancestralidade, valorizando a força do ọ̀rọ̀ (palavra) e o poder do àṣẹ (energia vital). Assim, o leitor encontra aqui não apenas traduções, mas também um mergulho profundo na essência espiritual e cultural da língua yorùbá.",
        destaques: [
            "Traduções diretas do português para o yorùbá com grafia e acentuação corretas",
            "Vocabulário voltado para rituais, cânticos e estudos linguísticos",
            "Termos de uso comum e expressões tradicionais yorùbá",
            "Ferramenta essencial para praticantes do Candomblé e estudiosos da cultura africana"
        ],
        dados: {
            "Autor": "Bàbá Akindele",
            "Editora": "Yorùbá History Channel",
            ...
            "Formato": "Digital (PDF) / Físico",
            "Páginas": "243",
            "Acesso": "Ebook (imediato) / Livro (de 5 a 15 dias úteis)"
        },
        linkCompra: "https://pay.hotmart.com/C102285413O",
        linkEbook: "https://pay.hotmart.com/C102285413O",
        linkFisico: "https://pay.hotmart.com/H102285293M"
    },
    "dicionario-you-por": {
        titulo: "Dicionário - Yorùbá - Português",
        preco: "R$ 99,99",
        precoEbook: "R$ 99,99",
        precoEbookOriginal: "R$ 129,99",
        precoFisico: "R$ 199,99",
        precoFisicoOriginal: "R$ 229,99",
        imagem: "img/dicionario_you_por.png?v=20251007",
        badges: [],
        descricao: "Neste guia fundamental, Bàbá Akindele apresenta uma das obras mais completas já publicadas sobre a língua sagrada dos Òrìṣà. O Dicionário Yorùbá–Português reúne centenas de palavras cuidadosamente selecionadas, traduzidas e organizadas com a grafia correta, acentuação tonal e significados preservados segundo a tradição linguística yorùbá.\n\nMais do que um simples dicionário, esta obra é um elo entre o sagrado e o cotidiano, um instrumento que auxilia estudantes, pesquisadores, iniciados e amantes da cultura yorùbá a compreender e pronunciar corretamente as palavras que ecoam nos cânticos, orações e rituais.\n\nCada termo foi tratado com profundo respeito à ancestralidade, valorizando a força do ọ̀rọ̀ (palavra) e o poder do àṣẹ (energia vital). Assim, o leitor encontra aqui não apenas traduções, mas um mergulho espiritual e cultural na essência viva da língua yorùbá.",
        destaques: [
            "Traduções diretas do yorùbá para o português, com grafia e acentuação corretas segundo o padrão nigeriano oficial",
            "Vocabulário voltado para rituais, cânticos e estudos linguísticos",
            "Termos de uso comum e expressões tradicionais yorùbá, preservando o sentido original",
            "Ferramenta essencial para praticantes do Candomblé, estudiosos e professores da cultura africana e afro-brasileira",
            "Obra ampliada e revisada, com 298 páginas de conteúdo cuidadosamente organizado"
        ],
        dados: {
            "Autor": "Bàbá Akindele",
            "Editora": "Yorùbá History Channel",
        ...
        linkCompra: "https://pay.hotmart.com/C102286815V",
        linkEbook: "https://pay.hotmart.com/C102286815V",
        linkFisico: "https://pay.hotmart.com/Y102286766P"
    },
    "combo-dicionarios": {
        titulo: "Combo Dicionários",
        preco: "R$ 179,99",
        precoEbook: "R$ 179,99",
        precoEbookOriginal: "R$ 259,98",
        precoFisico: "R$ 375,99",
        precoFisicoOriginal: "R$ 449,98",
        imagem: "img/combo_dicionario.png?v=20251007",
        badges: [],
        descricao: "Reúna em um só conjunto as duas obras fundamentais para o estudo da língua sagrada dos Òrìṣà. O Combo Dicionários Yorùbá–Português + Português–Yorùbá, de Bàbá Akindele, oferece o caminho completo para quem deseja ler, compreender, traduzir e pronunciar corretamente o Èdè Yorùbá, língua ancestral que conecta o homem aos Òrìṣà e à sabedoria dos antepassados.\n\nSão mais de 500 páginas de conhecimento, cuidadosamente revisadas, com a grafia correta, tons preservados e significados originais mantidos segundo os padrões da tradição yorùbá.",
        destaques: [
            "Dicionário Português–Yorùbá (243 páginas)",
            "Dicionário Yorùbá–Português (298 páginas)",
            "Mais de 500 páginas de conhecimento",
            "Grafia correta com tons preservados",
            "Significados originais segundo a tradição yorùbá",
            "Economia de R$ 79,99"
        ],
        dados: {
            "Autor": "Bàbá Akindele",
            ...
            "Ano": "2025",
            "Formato": "Digital (PDF) / Físico",
            "Total de Páginas": "541",
            "Livros Inclusos": "2 dicionários completos",
            "Valor Individual E-book": "R$ 259,98",
            "Valor Individual Físico": "R$ 449,98"
        },
        linkCompra: "https://pay.hotmart.com/H102287194R",
        linkEbook: "https://pay.hotmart.com/H102287194R",
        linkFisico: "https://pay.hotmart.com/X102287241L"
    }
};

// Função para sincronizar preços automaticamente entre cards, modal e configurador
function sincronizarPrecos() {
    console.log('Sincronizando preços em todos os componentes...');
    
    // Atualizar preços nos cards do HTML
    document.querySelectorAll('[data-produto]').forEach(card => {
        const produtoId = card.getAttribute('data-produto');
        const produto = produtos[produtoId];
        
        if (produto && produtoId !== 'combo-personalizado') {
            // Atualizar preços do E-book
            const precoEbookEl = card.querySelector('.preco-opcao:first-child .preco-valor');
            const precoEbookOriginalEl = card.querySelector('.preco-opcao:first-child .preco-original');
            
            if (precoEbookEl && produto.precoEbook) {
                precoEbookEl.textContent = produto.precoEbook;
            }
            if (precoEbookOriginalEl && produto.precoEbookOriginal) {
                precoEbookOriginalEl.textContent = produto.precoEbookOriginal;
            }
            
            // Atualizar preços do Livro Físico
            const precoFisicoEl = card.querySelector('.preco-opcao:last-child .preco-valor');
            const precoFisicoOriginalEl = card.querySelector('.preco-opcao:last-child .preco-original');
            
            if (precoFisicoEl && produto.precoFisico) {
                precoFisicoEl.textContent = produto.precoFisico;
            }
            if (precoFisicoOriginalEl && produto.precoFisicoOriginal) {
                precoFisicoOriginalEl.textContent = produto.precoFisicoOriginal;
            }
        }
    });
    
    // Atualizar preços no configurador personalizado se existir
    setTimeout(() => {
        if (typeof configuradorPersonalizadoEstado !== 'undefined') {
            console.log('Atualizando configurador personalizado...');
            // Sincronizar com produtos atuais - apenas livros individuais
            ['yoruba', 'obi', 'coletanea-orisa', 'coletanea-cargos', 'coletanea-iyami', 
             'ewe', 'ilu', 'odu', 'livro-ebos', 'ounje', 'oruko-nomes', 'dicionario-por-you', 'dicionario-you-por'].forEach(produtoId => {
                const produto = produtos[produtoId];
                if (produto) {
                    try {
                        // Usar preços ORIGINAIS (não promocionais) no configurador personalizado
                        let precoEbookOriginal = 0, precoFisicoOriginal = 0;
                        
                        // Priorizar preços originais para o combo personalizado
                        if (produto.precoEbookOriginal && produto.precoEbookOriginal.includes('R$')) {
                            precoEbookOriginal = parseFloat(produto.precoEbookOriginal.replace('R$ ', '').replace(',', '.'));
                        }
                        if (produto.precoFisicoOriginal && produto.precoFisicoOriginal.includes('R$')) {
                            precoFisicoOriginal = parseFloat(produto.precoFisicoOriginal.replace('R$ ', '').replace(',', '.'));
                        }
                        
                        // Atualizar configurador com preços originais
                        if (precoEbookOriginal > 0) {
                            configuradorPersonalizadoEstado.precos.ebook[produtoId] = precoEbookOriginal;
                        }
                        if (precoFisicoOriginal > 0) {
                            configuradorPersonalizadoEstado.precos.fisico[produtoId] = precoFisicoOriginal;
                        }
                    } catch (error) {
                        console.warn(`Erro ao processar preços do produto ${produtoId}:`, error);
                    }
                }
            });
            console.log('Configurador personalizado atualizado:', configuradorPersonalizadoEstado.precos);
        }
    }, 100);
}

// Função para atualizar um produto específico e sincronizar automaticamente
function atualizarProduto(produtoId, novosDados) {
    if (produtos[produtoId]) {
        // Atualizar os dados do produto
        Object.assign(produtos[produtoId], novosDados);
        
        // Sincronizar automaticamente todos os componentes
        sincronizarPrecos();
        
        console.log(`Produto ${produtoId} atualizado e sincronizado em todos os componentes.`);
    } else {
        console.error(`Produto ${produtoId} não encontrado.`);
    }
}

// Função para validar sincronização de preços
function validarSincronizacaoPrecos() {
    console.log('=== VALIDAÇÃO DE SINCRONIZAÇÃO DE PREÇOS ===');
    let problemas = [];
    
    Object.keys(produtos).forEach(produtoId => {
        const produto = produtos[produtoId];
        const cardElement = document.querySelector(`[data-produto="${produtoId}"]`);
        
        if (cardElement) {
            // Verificar preço ebook no card
            const precoEbookCard = cardElement.querySelector('.preco-ebook');
            if (precoEbookCard) {
                const precoTexto = precoEbookCard.textContent.replace(/[^\d,]/g, '').replace(',', '.');
                const precoCard = parseFloat(precoTexto);
                const precoOriginal = produto.preco.ebook;
                
                if (Math.abs(precoCard - precoOriginal) > 0.01) {
                    problemas.push(`${produtoId}: Preço ebook card (${precoCard}) ≠ original (${precoOriginal})`);
                }
            }
            
            // Verificar preço físico no card
            const precoFisicoCard = cardElement.querySelector('.preco-fisico');
            if (precoFisicoCard) {
                const precoTexto = precoFisicoCard.textContent.replace(/[^\d,]/g, '').replace(',', '.');
                const precoCard = parseFloat(precoTexto);
                const precoOriginal = produto.preco.fisico;
                
                if (Math.abs(precoCard - precoOriginal) > 0.01) {
                    problemas.push(`${produtoId}: Preço físico card (${precoCard}) ≠ original (${precoOriginal})`);
                }
            }
        }
        
        // Verificar configurador personalizado
        if (configuradorPersonalizadoEstado.precos[produtoId]) {
            const precoConfigurador = configuradorPersonalizadoEstado.precos[produtoId];
            
            if (Math.abs(precoConfigurador.ebook - produto.preco.ebook) > 0.01) {
                problemas.push(`${produtoId}: Preço ebook configurador (${precoConfigurador.ebook}) ≠ original (${produto.preco.ebook})`);
            }
            
            if (Math.abs(precoConfigurador.fisico - produto.preco.fisico) > 0.01) {
                problemas.push(`${produtoId}: Preço físico configurador (${precoConfigurador.fisico}) ≠ original (${produto.preco.fisico})`);
            }
        }
    });
    
    if (problemas.length === 0) {
        console.log('✅ Todos os preços estão sincronizados corretamente!');
        return true;
    } else {
        console.error('❌ Problemas de sincronização encontrados:');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Sincronizar todos os preços na inicialização
    sincronizarPrecos();
...
const livrosDisponiveis = {
    ...
    "dicionario-por-you": {
        nome: "Dicionário - Português - Yorùbá",
        imagem: "img/dicionario_por_you.png?v=20251007",
        precoEbook: 129.99,
        precoFisico: 219.99
    },
    "dicionario-you-por": {
        nome: "Dicionário - Yorùbá - Português",
        imagem: "img/dicionario_you_por.png?v=20251007",
        precoEbook: 129.99,
        precoFisico: 229.99
    }
...
let configuradorPersonalizadoEstado = {
    ...
    precos: {
        ebook: {
            'yoruba': 64.99,           // Yorùbá Descomplicado - R$ 64,99 (original) vs R$ 39,99 (promocional)
            'obi': 54.99,              // Aprendendo a Jogar Obì - R$ 54,99 (original) vs R$ 29,99 (promocional)  
            'coletanea-orisa': 59.99,  // Orixás e seus Domínios - R$ 59,99 (original) vs R$ 34,99 (promocional)
            'coletanea-cargos': 54.99, // Cargos do Candomblé - R$ 54,99 (original) vs R$ 29,99 (promocional)
            'coletanea-iyami': 54.99,  // Aprendendo sobre Ìyàmi - R$ 54,99 (original) vs R$ 29,99 (promocional)
            'ewe': 54.99,              // Ewé Òrìṣà - R$ 54,99 (original) vs R$ 29,99 (promocional)
            'ilu': 49.99,              // Ilú Odara - R$ 49,99 (original) vs R$ 24,99 (promocional)
            'odu': 59.99,              // Odù no Èèrìndílógún - R$ 59,99 (original) vs R$ 34,99 (promocional)
            'livro-ebos': 94.99,       // Livro dos Èbós - R$ 94,99 (original) vs R$ 69,99 (promocional)
            'ounje': 74.99,            // Òunjẹ́ Àṣẹ - R$ 74,99 (original) vs R$ 49,99 (promocional)
            'oruko-nomes': 54.99,      // Òrùkọ - Nomes dos Filhos - R$ 54,99 (original) vs R$ 29,99 (promocional)
            'dicionario-por-you': 129.99, // Dicionário Português-Yorùbá - R$ 129,99 (original) vs R$ 99,99 (promocional)
            'dicionario-you-por': 129.99  // Dicionário Yorùbá-Português - R$ 129,99 (original) vs R$ 99,99 (promocional)
        },
        fisico: {
            'yoruba': 124.99,          // Yorùbá Descomplicado - R$ 124,99 (original) vs R$ 99,99 (promocional)
            'obi': 94.99,              // Aprendendo a Jogar Obì - R$ 94,99 (original) vs R$ 79,99 (promocional)
            'coletanea-orisa': 124.99, // Orixás e seus Domínios - R$ 124,99 (original) vs R$ 99,99 (promocional)
            'coletanea-cargos': 104.99,// Cargos do Candomblé - R$ 104,99 (original) vs R$ 79,99 (promocional)
            'coletanea-iyami': 104.99, // Aprendendo sobre Ìyàmi - R$ 104,99 (original) vs R$ 79,99 (promocional)
            'ewe': 94.99,              // Ewé Òrìṣà - R$ 94,99 (original) vs R$ 69,99 (promocional) 
            'ilu': 94.99,              // Ilú Odara - R$ 94,99 (original) vs R$ 69,99 (promocional)
            'odu': 114.99,             // Odù no Èèrìndílógún - R$ 114,99 (original) vs R$ 89,99 (promocional)
            'livro-ebos': 144.99,      // Livro dos Èbós - R$ 144,99 (original) vs R$ 119,99 (promocional)
            'ounje': 124.99,           // Òunjẹ́ Àṣẹ - R$ 124,99 (original) vs R$ 99,99 (promocional)
            'oruko-nomes': 104.99,     // Òrùkọ - Nomes dos Filhos - R$ 104,99 (original) vs R$ 89,99 (promocional)
            'dicionario-por-you': 219.99, // Dicionário Português-Yorùbá - R$ 219,99 (original) vs R$ 189,99 (promocional)
            'dicionario-you-por': 229.99  // Dicionário Yorùbá-Português - R$ 229,99 (original) vs R$ 199,99 (promocional)
        }
    }
};
...
// Função de teste para executar no console do navegador
function testarSistemaCompleto() {
    console.log('=== TESTE COMPLETO DO SISTEMA ===');
    
    // Testar sincronização
    console.log('1. Testando sincronização...');
    sincronizarPrecos();
    
    // Aguardar um momento para a sincronização
    setTimeout(() => {
        console.log('2. Validando sincronização...');
        const sincronizado = validarSincronizacaoPrecos();
        
        console.log('3. Testando atualização de produto...');
        // Testar atualização (temporária para teste)
        const precoOriginalEbook = produtos['livro-yoruba'].preco.ebook;
        atualizarProduto('livro-yoruba', { preco: { ebook: 99.99, fisico: produtos['livro-yoruba'].preco.fisico } });
        
        setTimeout(() => {
            // Restaurar preço original
            atualizarProduto('livro-yoruba', { preco: { ebook: precoOriginalEbook, fisico: produtos['livro-yoruba'].preco.fisico } });
            console.log('4. Teste concluído! Preços restaurados.');
        }, 1000);
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('DOM carregado - inicializando sistema de sincronização...');
    
    // Sincronizar preços na inicialização
    sincronizarPrecos();
    
    // Verificar integridade dos dados após sincronização
    setTimeout(() => {
        const sincronizacaoOk = validarSincronizacaoPrecos();
        if (sincronizacaoOk) {
            console.log('✅ Sistema inicializado com todos os preços sincronizados!');
        } else {
            console.warn('⚠️ Sistema inicializado mas com problemas de sincronização detectados.');
        }
    }, 200);
    
    // Tornar funções disponíveis globalmente
    window.testarSistemaCompleto = testarSistemaCompleto;
    window.sincronizarPrecos = sincronizarPrecos;
    window.validarSincronizacaoPrecos = validarSincronizacaoPrecos;
    window.atualizarProduto = atualizarProduto;
    
    console.log('💡 Funções disponíveis no console:');
    console.log('   • testarSistemaCompleto() - Teste completo do sistema');
    console.log('   • sincronizarPrecos() - Sincronizar preços manualmente');
    console.log('   • validarSincronizacaoPrecos() - Validar sincronização atual');
    console.log('   • atualizarProduto(id, dados) - Atualizar produto específico');
    
    // Aguardar um pouco para garantir que todos os elementos estejam prontos
    setTimeout(() => {
        if (document.getElementById('modal-combo-personalizado')) {
            console.log('Inicializando configurador personalizado...');
            console.log('Dicionários no configuradorPersonalizadoEstado:', configuradorPersonalizadoEstado.precos.ebook['dicionario-por-you']);
            inicializarConfiguradorPersonalizado();
        } else {
            console.warn('Elemento modal-combo-personalizado não encontrado');
        }
    }, 100);
    
    // Forçar sincronização dos dicionários após carregamento completo
    setTimeout(() => {
        console.log('Forçando sincronização final dos dicionários...');
        sincronizarPrecos();
    }, 500);
});
